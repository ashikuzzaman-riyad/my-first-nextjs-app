...
export default function page() {
  return (
   <main className="bg-black py-16 px-6">
  <div className="max-w-5xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
      ...
      <div className="w-full h-72 bg-gray-800 rounded-2xl overflow-hidden hover:scale-105 transition-transform duration-300">
        <img
    ...
    {/* Mission Section */}
    <div className="bg-gray-900 shadow-lg rounded-3xl p-10 mb-16 hover:shadow-amber-500 hover:scale-105 transition-all duration-300">
      <h2 className="text-3xl font-semibold text-white mb-4">
        Our Mission
      </h2>
      <p className="text-gray-300 leading-relaxed">
    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {/* Card 1 */}
        <div className="bg-gray-900 p-6 rounded-2xl shadow-lg text-center hover:shadow-amber-500 hover:scale-105 transition-all duration-300">
